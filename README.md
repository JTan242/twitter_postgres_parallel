...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/JTan242/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/JTan242/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/JTan242/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/JTan242/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/JTan242/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/JTan242/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |     8m29.884s             |      0:17.54elapsed       | 
| `pg_normalized_batch`  |     1m48.217s             |      0:14.67elapsed       | 
| `pg_denormalized`      |     0m17.199s             |      0:03.88elapsed       | 
